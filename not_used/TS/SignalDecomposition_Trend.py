...
class cConstantTrend(cAbstractTrend):
    ...
    def fit(self):
        ...
        self.mTrendFrame[self.mOutName + "_residue"] = (
            target - self.mTrendFrame[self.mOutName]
        )
...
class cLag1Trend(cAbstractTrend):
    ...
    def fit(self):
        ...
        self.mTrendFrame[self.mOutName + "_residue"] = (
            target - self.mTrendFrame[self.mOutName].values
        )
...
class cTrendEstimator:
    ...
    def estimateTrends(self):
        ...
        for trend in self.mTrendList:
            ...
            if self.mOptions.mDebug:
                self.check_residue(
                    self.mTrendFrame[trend.mOutName + "_residue"].values,
                    trend.mOutName + "_residue",
                )
        pass
